...
Permalink.Utils.getScriptParameters = function() 
{
	...
	for (var i = 0; i < scripts.length; i++) {
		...
		if (idx > -1) {
			var queryString = src.substring(idx + ("campaignPage.js"/*tpa=http://myemail.constantcontact.com/campaignPage.js*/.length+1));
...
{
	Permalink.Utils.importStyleSheet("share-btn.css"/*tpa=http://myemail.constantcontact.com/page/js/page/css/share-btn.css*/, "head");
	if (typeof(jQuery) == "undefined") {
		Permalink.Utils.importScript("jquery.min.js"/*tpa=http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js*/, "head");
	}
	...
	Permalink.Utils.importScript("ga.js"/*tpa=http://www.google-analytics.com/ga.js*/, "head");
};
...
{	
	...
	if (isTrackingEnabled) {
		...
		targets = {
			"http://myemail.constantcontact.com/page/js/linkedin.post": "http://www.linkedin.com/shareArticle?url="+pageUrlEscaped,
			...
			"http://myemail.constantcontact.com/page/js/facebook.like": null,
			"http://myemail.constantcontact.com/page/js/facebook.send": null,
			"http://myemail.constantcontact.com/page/js/permalink.view": null,
	...
	// tracking pixel...
	var trackingPixel = '';
	if (isTrackingEnabled && targets["http://myemail.constantcontact.com/page/js/permalink.view"] != null) {
		trackingPixel = '<img src="'+targets["http://myemail.constantcontact.com/page/js/permalink.view"]+'&_ts='+ts+'" height="1" width="1" border="0" />';
	}
    ...
    '<div class="shr-bar">'+
    	'<div class="shr-bar-wrap">'+
			...
			'</div>'+
			'<script src="widgets.js"/*tpa=http://platform.twitter.com/widgets.js*/ type="text/javascript"></script>'+
	...
	window.fbAsyncInit = function() {
		...
		FB.Event.subscribe("edge.create", function(href, widget) {
			(new Image()).src = targets["http://myemail.constantcontact.com/page/js/facebook.like"]+"&_ts="+ts;
	    });
		// code to track when a user sends a message through facebook
		FB.Event.subscribe("http://myemail.constantcontact.com/page/js/message.send", function(href, widget) {
			(new Image()).src = targets["http://myemail.constantcontact.com/page/js/facebook.send"]+"&_ts="+ts;
	    });
